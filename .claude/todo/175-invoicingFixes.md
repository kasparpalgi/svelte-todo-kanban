...
- Under settings shall be possible to also add my company name, address, etc from who the invoice is and I may have multiple companies from where I invoice. Some may be VAT registered, some not so also set vat rate (default 0) for each company. All invoice settings bring uder invoices page not general settings.
