...
export type TodoFieldsFragment = {
	...
	created_at: string;
	updated_at: string;
	list?: { __typename?: 'lists'; id: string; name: string } | null;
};
...
export type DeleteTodosMutation = {
	__typename?: 'mutation_root';
	delete_todos?: { __typename?: 'todos_mutation_response'; affected_rows: number } | null;
};
...
export const TodoFieldsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'TodoFields' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'todos' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'due_on' } },
...
} as unknown as DocumentNode<TodoFieldsFragment, unknown>;
			...
			variableDefinitions: [
				{
					...
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'todos_bool_exp' } },
				...
				},
				{
					...
					type: {
						...
						type: {
							kind: 'NonNullType',
							type: { kind: 'NamedType', name: { kind: 'Name', value: 'todos_order_by' } }
						}
					},
					defaultValue: {
						kind: 'ObjectValue',
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TodoFields' } }]
						}
					}
				]
			}
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							...
							type: {
								kind: 'NonNullType',
								type: { kind: 'NamedType', name: { kind: 'Name', value: 'todos_insert_input' } }
							}
						}
					}
				}
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'insert_todos' },
						arguments: [
							{
								kind: 'Argument',
							...
							selections: [
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TodoFields' } }
										]
									}
								}
							]
...
export const UpdateTodosDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'UpdateTodos' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'where' } },
				...
				},
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'todos_set_input' } }
					}
				}
			],
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'update_todos' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'where' },
							...
							},
							{
								...
								value: { kind: 'Variable', name: { kind: 'Name', value: '_set' } }
							}
						],
						selectionSet: {
							kind: 'SelectionSet',
...
} as unknown as DocumentNode<UpdateTodosMutation, UpdateTodosMutationVariables>;
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'DeleteTodos' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'where' } },
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'delete_todos' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'where' },
...
} as unknown as DocumentNode<DeleteTodosMutation, DeleteTodosMutationVariables>;
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'where' } },
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'users_bool_exp' } },
					defaultValue: { kind: 'ObjectValue', fields: [] }
				},
				{
					kind: 'VariableDefinition',
					...
					type: {
						...
						type: {
							kind: 'NonNullType',
							type: { kind: 'NamedType', name: { kind: 'Name', value: 'users_order_by' } }
						}
					},
					defaultValue: { kind: 'ObjectValue', fields: [] }
				},
