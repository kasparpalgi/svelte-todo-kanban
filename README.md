...
Open-source Kanban board that two-way-syncs with your **GitHub issues** — built with SvelteKit, Hasura
GraphQL and PostgreSQL. Your developers stay in GitHub; your clients get a friendly board. A free,
self-hostable alternative to Trello (per-seat cost) and Jira (overkill for most teams).

![Svelte ToDo Kanban board synced with GitHub issues](docs/screenshot.png)
...
Prefer someone else to set it up? Managed self-host setup is ~£80 one-off (server ~£3/month) — see
[e-stonia.co.uk](https://e-stonia.co.uk).

### Features

- **Two-way GitHub sync** — cards ↔ issues, including comments
...
- SvelteKit + TypeScript + Tailwind CSS front end; Hasura GraphQL + PostgreSQL back end; Auth.js auth
...
Built by [Kaspar L. Palgi](https://e-stonia.co.uk) — SvelteKit, Hasura & AI development at Estonian rates.
Book a free 2-hour consultation at [e-stonia.co.uk](https://e-stonia.co.uk).