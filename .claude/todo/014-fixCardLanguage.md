When I open the card then there's always everything in English. Can you see why? In boards route I have Estonian as I have selected Estonian.
									...
									{#if editData.min_hours && editData.max_hours}
										<div in:scale class="mt-5 text-2xl">
											~{editData.min_hours && editData.max_hours
												? (editData.min_hours + editData.max_hours) / 2
												: '?'}h
										</div>
									{/if}
								</div>
