...
type Documents = {
    ...
    "\n\tquery GetTodosMinimal(\n\t\t$where: todos_bool_exp = {}\n\t\t$order_by: [todos_order_by!] = { sort_order: asc, due_on: desc, updated_at: desc }\n\t\t$limit: Int = 100\n\t\t$offset: Int = 0\n\t) {\n\t\ttodos(where: $where, order_by: $order_by, limit: $limit, offset: $offset) {\n\t\t\t...TodoMinimalFields\n\t\t}\n\t}\n": typeof types.GetTodosMinimalDocument,
    "\n\tquery GetTodoFull($id: uuid!) {\n\t\ttodos_by_pk(id: $id) {\n\t\t\t...TodoFullFields\n\t\t}\n\t}\n": typeof types.GetTodoFullDocument,
...
const documents: Documents = {
    "\n\tfragment TodoMinimalFields on todos {\n\t\tid\n\t\ttitle\n\t\tpriority\n\t\tdue_on\n\t\thas_time\n\t\tcompleted_at\n\t\tsort_order\n\t\tassigned_to\n\t\tlist_id\n\t\tgithub_issue_number\n\t\tgithub_url\n\t\tmin_hours\n\t\tmax_hours\n\t\tactual_hours\n\n\t\t# Minimal assignee info for avatar display\n\t\tassignee {\n\t\t\tid\n\t\t\tname\n\t\t\tusername\n\t\t\timage\n\t\t}\n\n\t\t# Minimal label info for badges\n\t\tlabels {\n\t\t\tlabel {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\tcolor\n\t\t\t}\n\t\t}\n\n\t\t# Minimal list info (no full board data)\n\t\tlist {\n\t\t\tid\n\t\t\tname\n\t\t\tboard {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t}\n\t}\n": types.TodoMinimalFieldsFragmentDoc,
    "\n\tfragment TodoFullFields on todos {\n\t\tid\n\t\ttitle\n\t\tcontent\n\t\tdue_on\n\t\thas_time\n\t\tsort_order\n\t\tpriority\n\t\tlist_id\n\t\tcompleted_at\n\t\tcreated_at\n\t\tupdated_at\n\t\tassigned_to\n\t\tgithub_issue_number\n\t\tgithub_issue_id\n\t\tgithub_synced_at\n\t\tgithub_url\n\t\tmin_hours\n\t\tmax_hours\n\t\tactual_hours\n\t\tcomment_hours\n\n\t\t# Full assignee object\n\t\tassignee {\n\t\t\tid\n\t\t\tname\n\t\t\tusername\n\t\t\timage\n\t\t\temail\n\t\t}\n\n\t\t# Full labels with all fields\n\t\tlabels {\n\t\t\tlabel {\n\t\t\t\t...LabelFields\n\t\t\t}\n\t\t}\n\n\t\t# Comments loaded only when needed\n\t\tcomments(order_by: { created_at: asc }) {\n\t\t\t...CommentFields\n\t\t}\n\n\t\t# Uploads loaded only when needed\n\t\tuploads {\n\t\t\tid\n\t\t\turl\n\t\t\tcreated_at\n\t\t}\n\n\t\t# Full list and board info\n\t\tlist {\n\t\t\tid\n\t\t\tname\n\t\t\tsort_order\n\t\t\tboard {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\talias\n\t\t\t\tsort_order\n\t\t\t\tgithub\n\t\t\t\tsettings\n\t\t\t}\n\t\t}\n\t}\n": types.TodoFullFieldsFragmentDoc,
    ...
    "\n\tquery GetTodosMinimal(\n\t\t$where: todos_bool_exp = {}\n\t\t$order_by: [todos_order_by!] = { sort_order: asc, due_on: desc, updated_at: desc }\n\t\t$limit: Int = 100\n\t\t$offset: Int = 0\n\t) {\n\t\ttodos(where: $where, order_by: $order_by, limit: $limit, offset: $offset) {\n\t\t\t...TodoMinimalFields\n\t\t}\n\t}\n": types.GetTodosMinimalDocument,
    "\n\tquery GetTodoFull($id: uuid!) {\n\t\ttodos_by_pk(id: $id) {\n\t\t\t...TodoFullFields\n\t\t}\n\t}\n": types.GetTodoFullDocument,
 ...
 */
export function graphql(source: "\n\tfragment TodoMinimalFields on todos {\n\t\tid\n\t\ttitle\n\t\tpriority\n\t\tdue_on\n\t\thas_time\n\t\tcompleted_at\n\t\tsort_order\n\t\tassigned_to\n\t\tlist_id\n\t\tgithub_issue_number\n\t\tgithub_url\n\t\tmin_hours\n\t\tmax_hours\n\t\tactual_hours\n\n\t\t# Minimal assignee info for avatar display\n\t\tassignee {\n\t\t\tid\n\t\t\tname\n\t\t\tusername\n\t\t\timage\n\t\t}\n\n\t\t# Minimal label info for badges\n\t\tlabels {\n\t\t\tlabel {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\tcolor\n\t\t\t}\n\t\t}\n\n\t\t# Minimal list info (no full board data)\n\t\tlist {\n\t\t\tid\n\t\t\tname\n\t\t\tboard {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').TodoMinimalFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tfragment TodoFullFields on todos {\n\t\tid\n\t\ttitle\n\t\tcontent\n\t\tdue_on\n\t\thas_time\n\t\tsort_order\n\t\tpriority\n\t\tlist_id\n\t\tcompleted_at\n\t\tcreated_at\n\t\tupdated_at\n\t\tassigned_to\n\t\tgithub_issue_number\n\t\tgithub_issue_id\n\t\tgithub_synced_at\n\t\tgithub_url\n\t\tmin_hours\n\t\tmax_hours\n\t\tactual_hours\n\t\tcomment_hours\n\n\t\t# Full assignee object\n\t\tassignee {\n\t\t\tid\n\t\t\tname\n\t\t\tusername\n\t\t\timage\n\t\t\temail\n\t\t}\n\n\t\t# Full labels with all fields\n\t\tlabels {\n\t\t\tlabel {\n\t\t\t\t...LabelFields\n\t\t\t}\n\t\t}\n\n\t\t# Comments loaded only when needed\n\t\tcomments(order_by: { created_at: asc }) {\n\t\t\t...CommentFields\n\t\t}\n\n\t\t# Uploads loaded only when needed\n\t\tuploads {\n\t\t\tid\n\t\t\turl\n\t\t\tcreated_at\n\t\t}\n\n\t\t# Full list and board info\n\t\tlist {\n\t\t\tid\n\t\t\tname\n\t\t\tsort_order\n\t\t\tboard {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\talias\n\t\t\t\tsort_order\n\t\t\t\tgithub\n\t\t\t\tsettings\n\t\t\t}\n\t\t}\n\t}\n"): typeof import('./graphql').TodoFullFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery GetTodosMinimal(\n\t\t$where: todos_bool_exp = {}\n\t\t$order_by: [todos_order_by!] = { sort_order: asc, due_on: desc, updated_at: desc }\n\t\t$limit: Int = 100\n\t\t$offset: Int = 0\n\t) {\n\t\ttodos(where: $where, order_by: $order_by, limit: $limit, offset: $offset) {\n\t\t\t...TodoMinimalFields\n\t\t}\n\t}\n"): typeof import('./graphql').GetTodosMinimalDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n\tquery GetTodoFull($id: uuid!) {\n\t\ttodos_by_pk(id: $id) {\n\t\t\t...TodoFullFields\n\t\t}\n\t}\n"): typeof import('./graphql').GetTodoFullDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
