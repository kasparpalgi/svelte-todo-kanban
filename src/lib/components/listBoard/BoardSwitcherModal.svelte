<!-- @file src/lib/components/listBoard/BoardSwitcherModal.svelte -->
<script lang="ts">
	...
	import { Layers, Settings, Users, Globe, Archive, RotateCcw } from 'lucide-svelte';
	...
	>
		<div class="flex items-center justify-between border-b p-4">
			<div class="flex items-center gap-1 rounded-md bg-muted p-1">
				...
				<button
					type="button"
					class="rounded px-3 py-1.5 text-sm font-medium transition-colors {activeTab === 'archived'
						? 'bg-background shadow-sm'
						: 'text-muted-foreground hover:text-foreground'}"
